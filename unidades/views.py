...
def cadastro_filial(request):
    ...
    if request.method == "GET":
        ...
        try:
            dados_filial = Filial(nome=nome, cnpj=cnpj, rua=rua, bairro=bairro, numero=numero, 
                                  cidade=cidade,  foto=foto, user=request.user)
            dados_filial.save()
...
def home(request):
    ...
    if request.method == "GET":
        ...
        context = {'saldos':saldos, 'filiais':filiais, 'tg':tg, 'tm':tm, 'soma': soma}
